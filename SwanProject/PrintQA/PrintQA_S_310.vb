...
Public Class PrintQA_S_310
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SwanProject.PrintQA_S_310.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintQA_S_310
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintQA_S_310 = New PrintQA_S_310()
        rpt.Site = Me.Site
        Return rpt
    End Function
