...
Public Class MBfrm
    ...
    Private Sub AddBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddBtn.Click
        ...
        Try
            SQLstr = "update stock_" & DBCB.Text & " set s_time=getdate() where s_code ='" & lblKEY.Text & "'"
            dtSQL.RunCommand(SQLstr)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Function GETQA(ByVal ID As String) As DataTable
        ...
        dtACC.QryDT("select s_code,s_id,s_date,s_prdt,s_csmr,s_supno,s_rea,s_reades,s_slip,s_qty,s_pre,s_price,s_hand,s_invo,p_bal,p_last,s_bal,p_place,s_blot from stock_" & DBCB.Text & " as t1 left join prdt_" & DBCB.Text & " as t2 on t1.s_prdt=t2.p_prdt where s_code like '" & ID & "' ")
        Return dtACC.dt
    ...
    Public Sub EDITDATA()
        Try
            ...
            For Each dr As DataRow In dt.Rows
                ...
                GV1.Rows.Add(dr("S_PRDT").ToString, dr("S_QTY").ToString, dr("S_REA").ToString, dr("S_CSMR").ToString, dr("s_reades").ToString, dr("S_supno").ToString, dr("P_LAST").ToString, dr("p_place").ToString, dr("S_bal").ToString)
    ...
    Private Sub CBREA_KeyDown(sender As Object, e As KeyEventArgs) Handles CBREA.KeyDown
        If e.KeyCode = Keys.Enter Then
            If CBREA.Text = "B" Then
                txtCond.Text = "ML"
            End If
