...
Public Class MAslipRPT_310
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SwanProject.MAslipRPT_310.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMAslipRPT_310
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MAslipRPT_310 = New MAslipRPT_310()
        rpt.Site = Me.Site
        Return rpt
    End Function
